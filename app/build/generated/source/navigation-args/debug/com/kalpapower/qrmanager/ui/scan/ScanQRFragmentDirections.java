...
public class ScanQRFragmentDirections {
  ...
  @NonNull
  public static ActionScanToProductDetail actionScanToProductDetail(@NonNull String serialNumber) {
    return new ActionScanToProductDetail(serialNumber);
  }

  public static class ActionScanToProductDetail implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionScanToProductDetail(@NonNull String serialNumber) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionScanToProductDetail setSerialNumber(@NonNull String serialNumber) {
      if (serialNumber == null) {
        throw new IllegalArgumentException("Argument \"serialNumber\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("serialNumber", serialNumber);
    ...
    public int getActionId() {
      return R.id.action_scan_to_productDetail;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionScanToProductDetail that = (ActionScanToProductDetail) object;
    ...
    public String toString() {
      return "ActionScanToProductDetail(actionId=" + getActionId() + "){"
