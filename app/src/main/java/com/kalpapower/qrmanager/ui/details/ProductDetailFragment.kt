...
class ProductDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val serialNumber = args.serialNumber
        product = databaseHelper.getProductBySerialNumber(serialNumber)
    ...
    private fun navigateToReportFault() {
        product?.let { p ->
            val action = ProductDetailFragmentDirections.actionProductDetailToReportFault(p.id)
    ...
    private fun handleProductNotFound() {
        ...
        errorText?.text = "Product not found with serial number: ${args.serialNumber}"
